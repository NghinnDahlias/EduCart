...
const categories = [
    ...
    },
    {
        ...
        description: "Giáo trình Kinh tế vi mô, Marketing căn bản, Quản trị học đang giảm giá sâu.",
        tag: "BUSINESS & ECONOMICS",
        image: "https://tuyensinh.uef.edu.vn/wp-content/uploads/2020/08/nganh-kinh-te.jpg",
        link: "Khám phá ngay",
        query: "KINH TẾ"
    }
];
...
export default function CategorySection() {
    ...
    // Always show exactly 2 categories by wrapping around the array
                        ...
                        >
                            ...
                            >
                                ...
                                <div className="absolute inset-0 flex flex-col justify-end p-6 text-white">
                                    ...
                                    <div className="mt-4 inline-flex items-center gap-1 font-semibold group-hover:gap-2 transition-all">
                                        {category.link}
                                        <span>→</span>
                                    </div>
                                </div>
